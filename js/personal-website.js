...
However, it is a bit difficult to find anything that will use watchify( browserify ), uglify and map the minimized file it easily without learning grunt/gulp, the tutorials don't work/the needed npm modules do not install correctly on my machine */
require( "./themes.js" );
require( "./index.js" );
