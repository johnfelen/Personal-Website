    ...
    <div class="col-xs-3"></div>
        <div class="col-xs-6">
            <img src="images/me.jpg" id="picture-of-me" alt="Picture of Me" width="100%"/>
                ...
                <p class="font-ubuntu-mono font-medium font-center color" id="static-continue">
...
<p class="font-ubuntu-mono font-medium font-center color" id="static-pokemon">
...
<div class="row" id="static-names">
    <div class="col-xs-3"></div>
    <div class="col-xs-6 container-main">
        <table class="font-ubuntu-mono font-header color color-border font-center fill-n-center" id="static-choose-name">
