        ...
        <div class="font-vollkorn font-small">
            ...
            <!--the résumé is under include_files because I did not see a point to make another folder for files when there is only going to be one external file, so I just put it with the php include files-->
                <a href="../include_files/JohnFelenRésumé.pdf" title="Download my R&eacute;sum&eacute;" target="_blank"><i class="fa fa-file-text fa-2x"></i></a>
                &nbsp;&nbsp;&nbsp;
