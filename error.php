<?php
    /*the following status array to handle all errors is based off of https://css-tricks.com/snippets/php/error-page-to-handle-all-errors/
    Furthermore the values are based on the error code descriptions here http://100pulse.com/http-statuscode/http-status-code-list.jsp*/
    ...
    "404" => [ "Not Found", "TThis is probably the most common status code. &nbsp;Your browser cannot locate the document corresponding to the URL you entered. &nbsp;An improperly typed URL is usually the cause. &nbsp;The document may also have been moved. &nbsp;If you cannot find it elsewhere on the site, it may have been permanently removed." ],
