    ...
    <div class="font-main font-small">
        ...
        <hr class="color-border"><hr class="color-border"><hr class="color-border"><hr class="color-border">  <!--this somehow fixes the way too much space between three <br>s and one <hr>, margins/padding did not fix the error but 4x <hr> works-->
